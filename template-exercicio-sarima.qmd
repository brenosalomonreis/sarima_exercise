...
Portanto, diante dos resultados de tendência, fica claro que a série precisa de diferenciação.

Além disso, os resultados de sazonalidade indicam que um modelo que considere sazonalidade (como o SARIMA) é necessário.

2. Quantas diferenças (regular e sazonal) o AutoARIMA aplicou? E os componentes AR/MA? Conseguiu observar isso no ACF/PACF?

O AutoARIMA aplicou uma diferença regular (d = 1) e uma sazonal. Os componentes AR aplicou 3 e o MA aplicou 2. O PACF permite observar o AR... O ACF permite observar o MA....
...
A previsão captura bem a sazonalidade, assim como a leve tendência de subida mencionada anteriormente. Os intervalos abrem um pouco após 12 meses, mas de forma coerente. 
